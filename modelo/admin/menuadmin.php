...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand text-white" href="./../../modelo/indexu.php">ComDia <?php if($fetch_info['rol']== 1){
                echo ('Administrador');}
                else{echo ('Usuario');} ?></a>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body">
              ...
              <li>
                <a class="dropdown-item disabled" href="#">TIPOS DE ALIMENTOS</a>
                    <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="panelctrl.php">Verduras</a>
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="offcanvasNavbarDropdown">
              <li>
                    <a class="dropdown-item" href="panelctrl.php">Recomendaciones</a>
