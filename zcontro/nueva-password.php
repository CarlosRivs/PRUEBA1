    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="nueva-password.php" method="POST" autocomplete="off">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="password" name="password" placeholder="Escribe tu nueva contraseña" required>
                    </div>
                    <div class="form-group">
